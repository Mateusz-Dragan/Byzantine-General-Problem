...
def main():
    initialblock = Block("First thing", [t1, t2])
    print(initialblock.block_data)
    print(initialblock.block_hash)
    ...
    n = int(input("Have many sizes will it go to"))
    message = input("We attack tomorrow BOYS")
    i = 0
    while i < n:
        bl = Block("King's orders", [message])
